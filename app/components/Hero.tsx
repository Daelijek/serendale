...
export default function Hero() {
    return (
        <section id="hero" className="relative min-h-screen flex flex-col justify-center items-center gap-4 sm:gap-5 md:gap-6 overflow-hidden pt-20 pb-8 sm:pt-24 md:pt-0">
